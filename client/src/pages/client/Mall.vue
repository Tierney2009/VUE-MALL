  ...
  <div class="Mall">
    <header>
      <div class="container clear">
        <span class="title" @click="navTo('/mall')">HUAMall 一站式选购平台</span>
    ...
    <div class="bottomInfo">
      <div class="container">
        ...
        <div class="intro footerItem">
          <p class="title">何为HUAMall</p>
          <p class="intro-p">HUAMall原创生活类电商品牌，秉承网易一贯的严谨态度，我们深入世界各地，从源头全程严格把控商品生产环节，力求帮消费者甄选到优质的商品</p>
          <div>
            关注我们：
