    ...
    <div class="content">
      <div class="goodsInfo">
        ...
        <div class="infoRight">
          ...
          <button class="buyBtn" @click="open">立即购买</button>
...
var pay = require('../../assets/img/pay.jpg')
export default {
  name: 'GoodsDetail',
  components:{
    NumberInput,
  ...
  methods:{
    ...
    onClick(){
      this.$router.push('/mall/personal/cart')
      //你要跳转的路由 还可以传参 当然也可以通过其他方式跳转
    },
    open(){
        this.$confirm(
          '<div >'+'订单价格：'+'<span style="color: red">'+this.goodsPrice+'</span>'+'</div>' +
          "<img src="+pay+" width=300px height=300px > ",
        '请扫描二维码在线支付'
          ,{
